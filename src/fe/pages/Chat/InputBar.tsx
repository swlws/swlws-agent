  ...
  return (
    <div className="border-t border-gray-200 bg-white px-4 py-4 dark:border-[#3f3f46] dark:bg-[#212121] sm:px-6">
      <div className="mx-auto w-full max-w-3xl">
        <div className="flex items-end gap-2 rounded-3xl border border-gray-300 bg-white p-2 shadow-sm transition-colors focus-within:border-gray-400 dark:border-[#4a4a4a] dark:bg-[#2f2f2f] dark:focus-within:border-[#666]">
          <textarea
            rows={1}
            value={value}
          ...
          <select
            ...
            disabled={loading}
            className="self-end rounded-full border border-gray-300 bg-white py-2 pl-3 pr-2 text-sm text-gray-700 outline-none transition-colors hover:border-gray-400 disabled:opacity-50 dark:border-[#4a4a4a] dark:bg-[#2f2f2f] dark:text-gray-300 dark:hover:border-[#666]"
          >
